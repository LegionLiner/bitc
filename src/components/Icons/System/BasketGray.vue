<template>
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1.5 3H2.5H10.5" stroke="#828D96" stroke-linecap="round" stroke-linejoin="round" />
        <path
        ...
        <path d="M5 5.5V8.5" stroke="#828D96" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M7 5.5V8.5" stroke="#828D96" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
</template>